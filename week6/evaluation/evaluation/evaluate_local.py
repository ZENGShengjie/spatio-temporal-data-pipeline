...
执行：
    python -m week6.evaluation.evaluation.evaluate_local
...
from week6.evaluation.evaluation import (
...
def main():
    ...
    print("\n[3] 写 summary.md...")
    out = Path("week6.evaluation/results/local_test")
    ...
    from week6.evaluation.evaluation.evaluate import write_summary
