...
执行（EC2）：
    python -m week6.evaluation.interpretability.attention_vis \\
...
from week6.evaluation.optimization.optuna_stf import STFSearchData, x_flat_to_x_node
...
def main():
    ...
    parser.add_argument("--weights", "--checkpoint",
                        ...
                        help="STF 模型权重路径")
    parser.add_argument("--output", default="week6.evaluation/results/interpretability/attention/")
