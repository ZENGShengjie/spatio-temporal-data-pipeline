...
执行（EC2）：
    pip install shap
    python -m week6.evaluation.interpretability.shap_analysis \\
...
sys.path.insert(0, str(_REPO / "week6.evaluation" / "interpretability"))
...
def main():
    ...
    parser.add_argument("--output", default="week6.evaluation/results/interpretability/shap/")
