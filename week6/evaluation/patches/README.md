...
from week6.evaluation.profiling.optimized_pipeline import OptimizedPipeline as SpatiotemporalPipeline
```
...
2. 应用 patch：
   ...
   echo "from week6.evaluation.patches.pipeline_inference_mode import patch_pipeline" >> week6/api/main.py
...
3. 重启 API 跑优化后评估：
   ...
   python -m week6.evaluation.evaluation.evaluate --model-tag optimized --output results/profiling/optimized/
   ```
