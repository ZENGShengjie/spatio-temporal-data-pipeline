...
调用方式（EC2 上）：
    ...
    python -m week6_evaluation.evaluation.evaluate --model-tag optuna --output results/optuna/
...
from week6_evaluation.evaluation.metrics import full_evaluation, compute_classification_metrics
from week6_evaluation.evaluation.profile_runner import (
...
def main():
    ...
    parser.add_argument("--output", default="week6_evaluation/results/baseline/")
