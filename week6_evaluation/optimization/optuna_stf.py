...
执行：
    python -m week6_evaluation.optimization.optuna_stf \\
        --n-trials 30 \\
        --timeout 7200 \\
        --output week6_evaluation/results/optuna/
"""
...
def main():
    ...
    parser.add_argument("--output", default="week6_evaluation/results/optuna/")
